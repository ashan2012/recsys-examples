...
torchrun --nproc_per_node 1 --nnodes 1 --node_rank 0 --master_addr localhost --master_port 6000 ./training/get_useremb.py --gin-config-file ./training/configs/gameid_retrieval_eval.gin  --output_file user_embeddings.json --max_samples 100 
